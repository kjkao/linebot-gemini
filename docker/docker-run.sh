...
ENVS="-e LINE_BOT_SECRET=$LINE_BOT_SECRET -e GEMINI_API_KEY=$GEMINI_API_KEY -e LINE_BOT_TOKEN=$LINE_BOT_TOKEN -e LINE_BOT_USERID=$LINE_BOT_USERID -e TZ=Asia/Taipei"
